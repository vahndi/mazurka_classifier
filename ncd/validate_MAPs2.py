...
from paths import loadRunSettingsList, getValidationSetFolders, getFolderNames
...
numProcesses = 12
settingsFileName = '/u7.swansea/s11/abpg162/project/run_settings/Run Settings - Validation.csv'
...
for settingsDict in settingsDicts:
    ...
    if not os.path.exists(resultsFn) and settingsDict['Run Name'] is not None:
        ...
        pieceIds = getValidationSetFolders(getFolderNames(piecesPath, contains = 'mazurka', orderAlphabetically = True))
        print 'Loading feature file dict...'
        featureFileDict = FFP.loadFeatureFileDictValidationSetFolders(piecesPath, settingsDict['Feature Name'])
        print '...done.'
