...
# v5 - now have trained features to < 0.0005 change in cost function so changed 
#      format of weightsFn
        ...
        if nextSettings is not None:
            for setting in nextSettings:
                ...
                if NNtype is not None:
                    ...
                    weightsFn = 'weights_corruption_%i_nin_48_nhdn_%i_basz_%i_lnrt_%s.csv' \
                    ...
                    biasesFn = 'biases_corruption_%i_nin_48_nhdn_%i_basz_%i_lnrt_%s.csv' \
                                % (setting['dA Corruption Level'], setting['dA Num Hidden Units'], 
                                   setting['dA Batch Size'], strLnRt)
