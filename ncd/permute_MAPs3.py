...
# v3: added number of features and frequency standardisations to the permutation
...
for settings in allSettings:
    ...
    if settingsDict['NN Type'] is not None:
        ...
        transformedFeatureFileDict = FFP.generateTransformedFeatureFileDict(
                                        featureFileDict, settingsDict['Number of Features'], settingsDict['Feature Name'],
                                        settingsDict['NN Type'], settingsDict['Number of Features'], settingsDict['NN # Hidden Units'], 
    ...
    NCDlist = calculateNCDs(processPool = processPool,
                            ...
                            numFeatures = settingsDict['Number of Features'], 
